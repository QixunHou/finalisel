; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/2556.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/2556.c"
...
define dso_local void @func(i32* nocapture %p, i32* nocapture %q) local_unnamed_addr #0 {
entry:
  %0 = load i32, i32* %p, align 4, !tbaa !2
  %1 = load i32, i32* %q, align 4, !tbaa !2
  store i32 %1, i32* %p, align 4, !tbaa !2
...
entry:
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 5, i32 4)
  ret i32 0
}
