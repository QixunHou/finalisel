; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3156.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3156.c"
...
define dso_local i32 @func(i32* readonly %a, i32* readonly %b) local_unnamed_addr #0 {
entry:
  %cmp = icmp ugt i32* %a, %b
  %cond = select i1 %cmp, i32* %a, i32* %b
  %0 = load i32, i32* %cond, align 4, !tbaa !2
  ret i32 %0
}
...
entry:
  ...
  store i32 8, i32* %b, align 4, !tbaa !2
  %cmp.i = icmp ugt i32* %a, %b
  %2 = select i1 %cmp.i, i32 10, i32 8
