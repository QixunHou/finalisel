; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3840.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3840.c"
...
if.then7:                                         ; preds = %if.then.3
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %add.4)
  br label %for.end11
...
if.then7.i:                                       ; preds = %if.then.3.i
  %call.i = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %add.4.i) #2
  br label %func.exit
