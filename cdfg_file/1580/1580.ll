; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1580.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1580.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [14 x i8] c"a = %d;a = %d\00", align 1

; Function Attrs: norecurse nounwind uwtable
define dso_local void @func(i32* nocapture %x, i32* nocapture %y) local_unnamed_addr #0 {
entry:
...
entry:
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 200, i32 100)
  ret i32 0
}
