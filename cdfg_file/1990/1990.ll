; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1990.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1990.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [13 x i8] c"%5d%5d%5d%5d\00", align 1

; Function Attrs: norecurse nounwind uwtable
define dso_local void @func(i32* nocapture %a) local_unnamed_addr #0 {
entry:
  %0 = bitcast i32* %a to <4 x i32>*
  %1 = load <4 x i32>, <4 x i32>* %0, align 4, !tbaa !2
  %2 = mul nsw <4 x i32> %1, %1
  %3 = bitcast i32* %a to <4 x i32>*
  store <4 x i32> %2, <4 x i32>* %3, align 4, !tbaa !2
  ret void
}
...
entry:
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32 1, i32 4, i32 9, i32 16, i32 undef)
  ret void
}
