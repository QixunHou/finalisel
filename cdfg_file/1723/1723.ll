; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1723.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/1723.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@main.str = internal global [24 x i8] c"turbo c and borland c++\00", align 16
@.str = private unnamed_addr constant [23 x i8] c"\D4\AD\CA\BC\EF\BF\BD\D6\B7\EF\BF\BD\EF\BF\BD\EF\BF\BD:%s\0A\00", align 1
@.str.1 = private unnamed_addr constant [30 x i8] c"\EF\BF\BD\EF\BF\BD\EF\BF\BD\EF\BF\BD\D2\BB\EF\BF\BD\EF\BF\BD\EF\BF\BD\D6\B7\EF\BF\BD:\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%c\00", align 1
@.str.3 = private unnamed_addr constant [10 x i8] c"str[]=%s\0A\00", align 1
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %ch) #4
  %call = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @main.str, i64 0, i64 0))
  %call1 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0))
  %call2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* nonnull %ch)
...
func.exit:                                        ; preds = %for.inc.i, %entry
  ...
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @main.str, i64 0, i64 0))
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %ch) #4
  ret void
}
