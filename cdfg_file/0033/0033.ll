; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/0033.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/0033.c"
...
entry:
  ...
  %mul = fmul float %x, 0x400921FF20000000
  %mul2 = fmul float %mul, %x
  %z.0 = select i1 %cmp, float -1.000000e+00, float %mul2
  ret float %z.0
}
...
entry:
  ...
  %mul.i = fmul float %1, 0x400921FF20000000
  %mul2.i = fmul float %1, %mul.i
  %z.0.i = select i1 %cmp.i, float -1.000000e+00, float %mul2.i
