; ModuleID = '/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3144.c'
source_filename = "/home/qixunhou/isel_pros/FinalIselV3.0/c_src_file/3144.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@__const.main.a = private unnamed_addr constant [20 x i8] c"i am a student\00\00\00\00\00\00", align 16
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 16 %0, i8* align 16 getelementptr inbounds ([20 x i8], [20 x i8]* @__const.main.a, i64 0, i64 0), i64 20, i1 false)
...
for.body.i:                                       ; preds = %for.inc23.i, %for.body.preheader.i
  ...
  %arrayidx.i = getelementptr inbounds [20 x i8], [20 x i8]* %a, i64 0, i64 %indvars.iv.next94.i
...
for.cond5.i:                                      ; preds = %for.body14.i, %for.cond5.preheader.i
  ...
  %arrayidx7.i = getelementptr inbounds [20 x i8], [20 x i8]* %a, i64 0, i64 %indvars.iv95.i
...
for.body31.i:                                     ; preds = %for.body31.i, %for.body31.preheader.i
  ...
  %9 = phi i8 [ 105, %for.body31.preheader.i ], [ %10, %for.body31.i ]
  ...
  %arrayidx27.i = getelementptr inbounds [20 x i8], [20 x i8]* %a, i64 0, i64 %indvars.iv.next92.i
...
while.body.i:                                     ; preds = %while.cond.preheader.i, %while.body.i
  ...
  %arrayidx50.i = getelementptr inbounds [20 x i8], [20 x i8]* %a, i64 0, i64 %indvars.iv.i
